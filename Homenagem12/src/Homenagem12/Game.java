...
public class Game extends Canvas implements Runnable{
	...
	private int curAnimation = 0,maxAnimation = 24;
	
	public Game() {
		sheet = new Spritesheet("/spritesheet.png");
		player = new BufferedImage[24];
		player[0] = sheet.getSprite(0, 0, 117, 29);
		player[1] = sheet.getSprite(0, 29, 118, 29);
		player[2] = sheet.getSprite(0, 0, 117, 29);
		player[3] = sheet.getSprite(0, 29, 118, 29);
		player[4] = sheet.getSprite(0, 0, 117, 29);
		player[5] = sheet.getSprite(0, 29, 118, 29);
		player[6] = sheet.getSprite(0, 0, 117, 29);
		player[7] = sheet.getSprite(0, 29, 118, 29);
		player[8] = sheet.getSprite(0, 0, 117, 29);
		player[9] = sheet.getSprite(0, 29, 118, 29);
		player[10] = sheet.getSprite(0, 0, 117, 29);
		player[11] = sheet.getSprite(0, 29, 118, 29);
		player[12] = sheet.getSprite(0, 0, 117, 29);
		player[13] = sheet.getSprite(0, 29, 118, 29);
	...
	public void render() {
		...
		g2.drawImage(player[curAnimation],x,176,null);
