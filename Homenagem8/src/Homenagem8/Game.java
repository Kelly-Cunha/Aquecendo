...
public class Game extends Canvas implements Runnable{
	...
	public void render() {
		...
		g.drawString("A sua existência alegra o meu viver, me motiva,", 48,40);
		g.drawString("me inspira, me fortalece,", 112,59);
		g.drawString("faz meu coração pulsar vigorosamente", 62,74);
		g.drawString("todos os dias;", 133,89);
		g.drawString("agradeço a Deus pelo presente que Ele me deu: meu filho.", 12,102);
		
		g.setColor(Color.cyan);
		g.drawString("Te amo,", 142,117);
		g.drawString("FeLiz AniVerSáriO!!!", 45,131);
		g.drawString("Parabéns por quem você é.", 146,150);
		g.setColor(Color.blue);
		g.drawString("Parabéns por quem você é.", 145,150);
		g.drawString("FeLiz AniVerSáriO!!!", 44,131);
